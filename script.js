...
// Make sure Supabase is loaded in your HTML via CDN v2:
    ...
    newlywedForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        if (!res.ok) {
          ...
          console.error('Newlywed submission error:', errorText);
